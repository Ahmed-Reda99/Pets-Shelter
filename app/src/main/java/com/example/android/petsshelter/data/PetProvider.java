...
public class PetProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        /**
         * Set notification uri on this cursor so if the data on this uri changes
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        /**
         * Notify all listeners that the data has been changed for the pets content uri
         */
    ...
    private int updatePet(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if(values.containsKey(PetEntry.COLUMN_PET_WEIGHT))
        {
            ...
            if(weight < 0)
                throw new IllegalArgumentException("Pet's weight must be 0 or greater'");
        }
