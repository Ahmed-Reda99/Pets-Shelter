...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    /** a boolean which will be true if the user updates part of the pet form*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout parentView = (LinearLayout) findViewById(R.id.editorView);
    ...
    private void savePet()
    {
        ...
        if(name.isEmpty())
        {
            Toast.makeText(this, getString(R.string.editor_name_empty),
                    Toast.LENGTH_SHORT).show();
        }
        else {
            // Check that the gender is one of these constants: GENDER_MALE, or GENDER_FEMALE
            int genderChoice = values.getAsInteger(PetEntry.COLUMN_PET_GENDER);
            if (!(genderChoice == PetEntry.GENDER_MALE || genderChoice == PetEntry.GENDER_FEMALE))
            {
                Toast.makeText(this, getString(R.string.editor_gender_unknown),
                        Toast.LENGTH_SHORT).show();
            } else{
                if(petUri == null)
                {
                    ...
                    // Update pet into the provider, returning the content URI for the new pet.
                    int rowsAffected = getContentResolver().update(petUri, values, null, null);
                    if (rowsAffected == 0) {
                        // If the rowsAffected = 0, then there was an error with update.
    ...
    private void deletePet() {
        ...
        if (rowsDeleted == 0) {
            // If the rowsDeleted = 0, then there was an error with delete.
    ...
    /**
     * Function for closing the keyboard where ever i pressed on the screen
     */
